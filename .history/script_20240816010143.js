ript>
        ...
        function display5DayForecast(forecastList) {
            ...
            const filteredForecast = forecastList.filter(forecast => forecast.dt_txt.includes("12:00:00"));
            ...
            filteredForecast.slice(0, 5).forEach(forecast => {
                ...
                weatherCard.className = `p-4 rounded-lg shadow-md flex-1 md:max-w-xs ${isToday ? "bg-gradient-to-r from-blue-500 to-indigo-700 text-white" : "bg-gray-100 text-gray-800"}`;
